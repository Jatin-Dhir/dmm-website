...
export const images: Record<string, Img> = {
  ...
  caseCasa: stand('caseCasa', 'Hoardings lining a busy Indian road at night, traffic streaking past', '50% 42%'),
  ...
  caseTotebae: stand('caseTotebae', 'A laptop showing search and traffic analytics'),
  ...
  caseMagique: stand('caseMagique', 'Giant LED screens wrapping a building at night'),
  ...
  caseStallone: stand('caseStallone', 'A creator filming a reel with a phone and a ring light'),
